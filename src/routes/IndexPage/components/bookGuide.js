...
const BookGuide = ({loading, bookListData}) => {
      ...
      <li key={item.Id}>
        ...
        <div className={styles.content}>
          <h4 className={styles.title}>
            <Link to="/main/bookDetail" target="_blank" rel="noopener noreferrer">{wordLimit(item.Name, 17)}</Link>
          </h4>
  ...
  return (
    <div className={styles.bookGuide}>
      <GeneralHead showIcon={true} title="电子书" url="/main/library"></GeneralHead>
