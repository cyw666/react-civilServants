import { fetch, config as api } from '../utils/'
...
/*班级文章*/
export function classArticleDetail(data) {
  return fetch.post(api.ClassArticleDetail.url, { ...api.ClassArticleDetail.data, ...data });
}
...
export function photoAlbumList(data) {
  return fetch.post(api.PhotoAlbumList.url, { ...api.PhotoAlbumList.data, ...data });
}

/*班级相册 照片*/
export function photoPreview(data) {
  return fetch.post(api.PhotoPreview.url, { ...api.PhotoPreview.data, ...data });
}

/*添加话题*/
export function classTopicAdd(data) {
  return fetch.post(api.ClassTopicAdd.url, { ...api.ClassTopicAdd.data, ...data });
}

/*发布文章 话题 type: topic paper*/
export function classPublishArticle(data) {
  return fetch.post(api.ClassPublishArticle.url, { ...api.ClassPublishArticle.data, ...data });
}

/*培训班--获取分类 type: topic paper*/
export function getTrainingArticleCategory(data) {
  return fetch.post(api.GetTrainingArticleCategory.url, { ...api.GetTrainingArticleCategory.data, ...data });
}
